...
Ces deux supports existent séparément. Les données techniques sont donc dissociées de la représentation visuelle des zones de production.
...
- Visualiser les postes sur le plan du site.
- Associer chaque poste à une zone.
- Rechercher rapidement un poste.
- Consulter ses informations techniques.
- Ajouter, déplacer et supprimer des marqueurs.
